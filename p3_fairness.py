...
def run():
    ...
    for DELAY in delay_list:
        ...
        bytes_transferred=0 
        with open("server1_output.log", "r") as file:
            for line in file:
        ...
        with open("client1_output.log", "r") as file:
            for line in file:
                # Check if the line starts with 'len_data'
                if line.startswith("len_data"):
                    # Split the line to extract the number after "len_data :"
                    ...
                    number = int(parts[1].strip())
                    bytes_transferred += number
        throughput1=bytes_transferred/ttc


        bytes_transferred=0 
        with open("server2_output.log", "r") as file:
            for line in file:
                # Check if the line starts with 'len_data'
                if line.startswith("len_data"):
                    # Split the line to extract the number after "len_data :"
                    ...
                    number = int(parts[1].strip())
                    bytes_transferred += number
        with open("client2_output.log", "r") as file:
            for line in file:
                # Check if the line starts with 'len_data'
                if line.startswith("len_data"):
                    # Split the line to extract the number after "len_data :"
                    ...
                    number = int(parts[1].strip())
                    bytes_transferred += number
                    time2_val=int(parts[2].strip())
                    time2=datetime.fromtimestamp(timestamp)
        throughput2=bytes_transferred/ttc
